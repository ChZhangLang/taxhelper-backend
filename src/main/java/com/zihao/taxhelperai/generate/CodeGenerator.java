package com.zihao.taxhelperai.generate;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // 指定生成参数
        String packageName = "com.zihao.taxhelperai";
        String dataName = "计税记录";
        String dataKey = "taxRecord";
        String upperDataKey = "TaxRecord";
